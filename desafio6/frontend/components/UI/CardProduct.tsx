  ...
  return (
    <div className="w-1/4 h-1/6 flex flex-col bg-white rounded-lg shadow-lg">
        ...
        <div className="px-5 pb-5">
            <p className="text-xl font-semibold tracking-tight text-gray-900">Taza boquita</p>
            <div className="flex flex-col mt-2.5 mb-5">
                <p>La mejor taza de boca está aca</p>
            </div>
            <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded">Quedan 5</span>
