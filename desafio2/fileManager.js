...
class Contenedor {
    ...
    async getById(number){
        try {
            ...
            if(objectInfo.length === 0) return console.log(null)
            if(objectInfo.length !== 0) return console.log(objectInfo)
        } catch (error) {
...
const contain1 = new Contenedor('productos.txt')
/* const saveObject1 = contain1.save(objectProduct3) */
